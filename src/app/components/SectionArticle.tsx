  ...
  return (
    <main className="bg-[#FBF9F7] w-full py-6 sm:py-8 md:py-12 lg:py-14 px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* Main content */}
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-7 lg:gap-8 justify-center">
          {/* Featured articles */}
          <div className="flex flex-wrap gap-4 sm:gap-6 md:gap-7 lg:gap-8 justify-center">
            {featuredArticles.map((article) => (
              <Card
                key={article.id}
                className="w-full sm:w-[320px] md:w-[350px] lg:w-[300px] h-[320px] sm:h-[400px] md:h-[430px] lg:h-[460px] p-0 bg-transparent border-0 relative overflow-hidden"
              >
                <CardContent className="p-0 h-full">
                  ...
                  >
                    ...
                    {/* Date badge */}
                    <div className="absolute w-[130px] sm:w-[140px] md:w-[150px] lg:w-[160px] h-7 sm:h-8 md:h-9 lg:h-10 top-[60%] sm:top-[363px] left-4 sm:left-[54px] bg-[#d99541] rounded-md flex items-center justify-center">
                    ...
                    <div className="absolute w-full h-[70px] sm:h-[80px] md:h-[85px] lg:h-[90px] left-0 right-0 bottom-0 rounded-[0px_0px_15px_15px] sm:rounded-[0px_0px_16px_16px] md:rounded-[0px_0px_18px_18px] lg:rounded-[0px_0px_20px_20px] bg-gradient-to-t from-[#1f3359] via-[rgba(31,51,89,0.56)] to-[rgba(31,51,89,0.05)]">
                      <h2 className="absolute w-[calc(100%-32px)] sm:w-[calc(100%-36px)] md:w-[calc(100%-40px)] lg:w-[calc(100%-44px)] bottom-[14px] sm:bottom-[16px] md:bottom-[18px] lg:bottom-[20px] left-4 sm:left-[54px] font-['Raleway',Helvetica] font-semibold text-white text-base sm:text-lg md:text-[19px] lg:text-[20px] leading-tight sm:leading-[24px] md:leading-[26px] lg:leading-[28px]">
                        {article.title}
                      </h2>
                    </div>
                  </div>
          ...
          {/* Side articles */}
          <div className="flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 mt-4 sm:mt-5 md:mt-6 lg:mt-0">
            {sideArticles.map((article) => (
              <Card
                key={article.id}
                className="flex border-0 bg-transparent p-0"
              >
                <CardContent className="flex gap-2 sm:gap-3 md:gap-4 p-0">
                  <img
                    className="w-[90px] h-[90px] sm:w-[120px] sm:h-[100px] md:w-[140px] md:h-[120px] lg:w-[150px] lg:h-[130px] object-cover"
                    alt={article.title}
                    src={article.image}
                  />
                  <div className="flex items-center">
                    <h3 className="w-full sm:w-[140px] md:w-[150px] lg:w-[160px] font-['Raleway',Helvetica] font-extrabold text-[#1f3359] text-xs sm:text-sm md:text-[14px] lg:text-[15px] tracking-[0.4px] sm:tracking-[0.5px] md:tracking-[0.6px] lg:tracking-[0.65px] leading-[18px] sm:leading-[20px] md:leading-[22px] lg:leading-[24px]">
                      {article.title}
                    </h3>
                  </div>
                </CardContent>
